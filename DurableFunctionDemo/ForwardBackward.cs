...
namespace DurableFunctionDemo
{
    ...
    {
        [FunctionName("ForwardBackward")]
        public static async Task<string> ForwardBackwardOrchestrator(
            [OrchestrationTrigger] IDurableOrchestrationContext context,
            ILogger log)
        {
            log.LogWarning("In {functionName}", nameof(ForwardBackwardOrchestrator));
